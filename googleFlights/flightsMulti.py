...
def getSearchQueryBKK():
    ...
    daterangeOctNov = [{'year': 2024, 'month': 10, 'daysMin': 1, 'daysMax': 31}, {'year': 2024, 'month': 11, 'daysMin': 1,'daysMax': 15}]
    incrementDaysRange = 10 # 80 start
    innerIncrementDaysRange = 17 # 60 start
    maxDaysInFirstCountryTotal = 7
    minDaysInFirstCountryEachSide = 1
...
def getSearchQuerySEOUL():
    ...
    daterangeAugSep = [{'year': 2024, 'month': 8, 'daysMin': 1, 'daysMax': 0}, {'year': 2024, 'month': 9, 'daysMin': 15, 'daysMax': 30}]
    daterangeOctNov = [{'year': 2024, 'month': 10, 'daysMin': 1, 'daysMax': 31}, {'year': 2024, 'month': 11, 'daysMin': 1,'daysMax': 0}]
    incrementDaysRange = 10 # 80 start
    innerIncrementDaysRange = 17 # 60 start
    maxDaysInFirstCountryTotal = 7
    minDaysInFirstCountryEachSide = 1
